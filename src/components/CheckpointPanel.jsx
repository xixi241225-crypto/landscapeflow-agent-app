      ...
      {checkpoint.id === 'checkpoint-2' && (
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 gap-3 xl:grid-cols-3">
            <label className="text-[11px] text-gray-600">融合要求<textarea rows="3" className="form-input resize-none mt-1 !text-xs" value={decisionDraft.fusionRequirements || ''} onChange={(event) => setDecisionDraft((prev) => ({ ...prev, fusionRequirements: event.target.value }))} onBlur={saveDecision} placeholder="例如：采用 B 的活力核心，融合 C 的雨水花园…" /></label>
