...
export const CHECKPOINTS = [
  ...
  { id: 'checkpoint-2', order: 2, afterAgent: 3, name: '方案方向决策', description: '由设计师在三个概念方向中确认当前方案；如均不满意，可返回 Agent 2 重新生成。' },
  { id: 'checkpoint-3', order: 3, afterAgent: 4, name: '设计说明书分项确认', description: '设计师逐项复核 Design Statement（含六项专业策略），通过或提出专业修改意见。' },
  { id: 'checkpoint-4', order: 4, afterAgent: 5, name: '视觉方案挑选', description: '设计师比较儿童活动场景视觉候选，并确认采用方向。' },
